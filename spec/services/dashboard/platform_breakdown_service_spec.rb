...
RSpec.describe Dashboard::PlatformBreakdownService do
  describe '#call' do
    it 'groups earnings by platform and returns top 5 by amount' do
      create(:earning, date: Date.new(2025, 6, 1),  amount: 800, platform: 'uber')
      create(:earning, date: Date.new(2025, 6, 2),  amount: 500, platform: 'ifood')
      create(:earning, date: Date.new(2025, 6, 3),  amount: 300, platform: 'rappi')
      create(:earning, date: Date.new(2025, 6, 4),  amount: 200, platform: 'shopee')
      create(:earning, date: Date.new(2025, 6, 5),  amount: 100, platform: 'amazon')
      create(:earning, date: Date.new(2025, 6, 6),   amount:  50, platform: 'nine_nine')
    ...
    it 'computes percent of total per platform' do
      create(:earning, date: Date.new(2025, 6, 1), amount: 750, platform: 'uber')
      create(:earning, date: Date.new(2025, 6, 2), amount: 250, platform: 'ifood')
    ...
    it 'falls back to slate color for platforms without META mapping' do
      create(:earning, date: Date.new(2025, 6, 1), amount: 100, platform: 'other')
    ...
    it 'covers the whole year when month is nil' do
      create(:earning, date: Date.new(2025, 1, 1),  amount: 100, platform: 'uber')
      create(:earning, date: Date.new(2025, 12, 1), amount: 200, platform: 'uber')
    ...
    it 'respects custom limit' do
      ...
      result = described_class.new(year: 2025, month: 6, limit: 3).call
