...
RSpec.describe ConfirmActionComponent, type: :component do
  ...
  it 'renders the description in both variants when description is provided' do
  ...
  it 'applies blue icon theme when icon_theme is :blue' do
    html = view_context.render(
      described_class.new(
        title:          'Confirmação',
  ...
  it 'falls back to slate icon theme when icon_theme is not recognized' do
    html = view_context.render(
      described_class.new(
        title:          'Confirmação',
        icon:           PhlexIcons::Lucide::Info,
  ...
  it 'does not render any _method hidden input when confirm_method is :post' do
    html = view_context.render(
      described_class.new(
        title:          'Confirmar',
  ...
  it 'disables turbo on the confirm form when turbo is disabled' do
    html = view_context.render(
      described_class.new(
        title:          'Sair da conta?',
        icon:           PhlexIcons::Lucide::LogOut,
