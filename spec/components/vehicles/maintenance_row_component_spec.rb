...
RSpec.describe Vehicles::MaintenanceRowComponent, type: :component do
  def entry_for(vehicle:, **overrides)
  ...
  describe '#view_template' do
    it 'renders an on-track item with catalog label and remaining km' do
      ...
      entry = entry_for(vehicle: vehicle, category: 'oil_change', last_done_km: 158_000, interval_km: 5_000)

      html = view_context.render(described_class.new(**entry))
